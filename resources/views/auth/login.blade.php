    ...
    <div class="row justify-content-center">
        <div class="col-md-12" style="margin-top:30px;">
            <form action="{{ route('login') }}" method="POST" class="p-4 border rounded">
                ...
                <div class="row form-group mb-4">
                    <div class="col-md-12 mb-3 mb-md-0">
                        <span> <input type="submit" name="submit" value="Log In" class="btn px-4 btn-primary text-white"></span>
                        <span> <input type="Reset" name="reset" value="Reset" class="btn px-3 btn-info text-white ml-1"></span>
                    </div>
                </div>
            </form>
